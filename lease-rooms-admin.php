        ...
        if(isset($_REQUEST['id_client']))
            {
                ...
                $query="INSERT into `locations` (id_client, nom_client, prenom_client, nbrAdult, nbrEnfant, dateEntree, dureeSejour, chambre,  batiment, modePaiement) 
    ...
    ?>
       ...
       <section class="add-client">
            <div class="add-client-text">
                    <h1>Enregistrement de location</h1>
            </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="add-contenair">
                        Choisir le niveau   <select name="level">
                                                ...
                                                <option>Bloc 72 1er</option>
                                                <option>Bloc 72 2e</option>
                                                <option>Bloc 48 1er</option>
